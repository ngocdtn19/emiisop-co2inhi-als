...
for item in mon:
    ...
    for chunk in pd.read_table(
        ...
        % item,
        chunksize=2500000,
    ):  ### Output file from the chaser_file_preperation_for_ak.py

        # for chunk in pd.read_table(
        #     "/mnt/dg2/hoque/TROPOMI_model_analysis/New_emission_chaser_2019_2020/2019/Chaser_ch2o_jan_all_level_2019_new1.txt"
        #     % item,
        #     chunksize=2500000,
        # ):
                    ...
                    for z in range(0, len(h4)):
                        ...
                        if len(df_model_1) != len(df_model_2):
                            ...
                            if len(Lat1) == 0 or len(Lat2) == 0:
                                ...
                                for k in range(0, len(Lat_re_mod)):
